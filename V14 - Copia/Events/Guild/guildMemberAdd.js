...
module.exports = {
    ...
    async execute(member) {
        Schema.findOne({ Guild: member.guild.id }, async (err, data) => {
            ...
            let img = await loadImage("https://upload.wikimedia.org/wikipedia/commons/thumb/5/5a/Animated_Wallpaper_Windows_10_-_Wallpaper_Engine.gif/340px-Animated_Wallpaper_Windows_10_-_Wallpaper_Engine.gif")
